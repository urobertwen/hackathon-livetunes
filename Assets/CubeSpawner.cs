...
public class CubeSpawner : MonoBehaviour
{
    ...
    void initScene()
    {
        ...
        bouncerScale = spawner.transform.localScale;
        bouncerPosition = spawner.transform.position;
        SetCubeTargets();
        SetCubeSpeeds();
        SpawnCubes();
    }
    ...
    void SpawnCubes()
    {
        for (int i = 0; i < numberOfCubes; i++)
        {
            Vector3 randPosition = new Vector3(Random.Range(-bouncerScale.x, bouncerScale.x), Random.Range(-bouncerScale.y, bouncerScale.y), Random.Range(-1.5f*bouncerScale.z, 1.5f*bouncerScale.z));
            Vector3 spawnPosition = randPosition + bouncerPosition;
